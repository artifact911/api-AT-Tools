...
//        return ResponseEntity.status(HttpStatus.OK).contentType(MediaType.APPLICATION_JSON).body("Hello World!");
        HelloWorld helloWorld = new HelloWorld(SchoolApi.CITY_API);
    ...
    public ResponseEntity<?> cityById(
        ...
        try {
            ...
            return getErrorResp(HttpMethod.GET, SchoolApi.CITY_API, HttpStatus.INTERNAL_SERVER_ERROR, e.getMessage());
        }
    }
    ...
    public ResponseEntity<?> newCity(@RequestBody CreateUpdateCityReqBody body) {
        try {
            ...
            return getErrorResp(HttpMethod.POST, SchoolApi.CITY_API, HttpStatus.INTERNAL_SERVER_ERROR, e.getMessage());
        }
    }
    ...
    public ResponseEntity<?> editCity(@PathVariable("cityId") Integer id,
        ...
        try {
            ...
            return getErrorResp(HttpMethod.PATCH, SchoolApi.CITY_API, HttpStatus.INTERNAL_SERVER_ERROR, e.getMessage());
        }
    }
    ...
    public ResponseEntity<?> putCity(@PathVariable("cityId") Integer id,
        ...
        try {
            ...
            return getErrorResp(HttpMethod.PUT, SchoolApi.CITY_API, HttpStatus.INTERNAL_SERVER_ERROR, e.getMessage());
        }
    }
    ...
    public ResponseEntity<?> deleteCity(@PathVariable("cityId") Integer id) {
        try {
            ...
            return getErrorResp(HttpMethod.DELETE, SchoolApi.CITY_API, HttpStatus.INTERNAL_SERVER_ERROR, e.getMessage());
        }
    }
}
